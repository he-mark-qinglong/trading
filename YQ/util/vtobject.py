...
class VtIndexPrice(VtBaseData):
    """指数数据"""

    def __init__(self):
        super(VtIndexPrice, self).__init__()
...
class VtExecutionData(VtBaseData):
    """手续费"""

    def __init__(self):
        super(VtExecutionData, self).__init__()

        self.makerFee = None
        self.makerFeeRate = None
        self.takerFee = None
        self.takerFeeRate = None
...
class VtOrderData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.orderid = EMPTY_STRING             # 订单编号
        self.clientid = EMPTY_STRING           # 订单在vt系统中的唯一编号，通常是 Gateway名.订单编号
        
        # 报单相关
        self.direction = EMPTY_UNICODE          # 报单方向
        self.offset = EMPTY_UNICODE             # 报单开平仓
        self.price = EMPTY_FLOAT                # 报单价格
        self.quantity = EMPTY_FLOAT             # 报单总数量
        self.filledquantity = EMPTY_FLOAT       # 报单总成交数量
        self.tradeprice = EMPTY_FLOAT           # 当前成交价
        self.tradevol = EMPTY_FLOAT             # 最近一笔成交数量
        ...
        self.leftquantity = EMPTY_INT  # 订单还未成交数量(剩余量)
        self.lastOrderTime = EMPTY_STRING  # 订单最新(最后)成交时间
        self.ordType = EMPTY_STRING  # 订单类型
...
class VtPositionData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.currency = EMPTY_STRING            # 盈亏计算币种
        self.kind = EMPTY_STRING                # 持仓类型：现货，期货，期权
        self.liqPrice = EMPTY_FLOAT             # 强平价
        self.floatingPl = EMPTY_FLOAT           # 浮动盈亏
        self.delta = EMPTY_FLOAT                # 期权delta
        self.margin = EMPTY_FLOAT               # 持仓保证金
...
class VtbalanceData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.exchange = EMPTY_STRING
        self.coin = EMPTY_STRING            # 币种
        self.total = EMPTY_FLOAT            # 实时总资产
        self.frozen = EMPTY_FLOAT           # 实时冻结
        self.available = EMPTY_FLOAT        # 实时可用
        self.init = EMPTY_FLOAT             # 策略启动时的总资产
        self.incr = EMPTY_FLOAT             # 策略启动后资产增量